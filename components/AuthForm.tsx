                        ...
                        {type === "sign-up" && (
                            <>
                                <div className="flex gap-4">
                                    <CustomInput 
                                    control={form.control} name="firstName" label="First Name" placeholder="ex: John"
                                    />
                                    <CustomInput 
                                        control={form.control} name="lastName" label="Last Name" placeholder="ex: Doe"
                                    />
                                </div>
                                ...
                                <div className="flex gap-4">
                                    <CustomInput
                                        control={form.control} name="province" label="Province" placeholder="ex: KZN"
                                    />
                                    <CustomInput
                                ...
                                <div className="flex gap-4">
                                    <CustomInput 
                                        ...
                                        />
                                    <CustomInput 
                                        control={form.control} name="rsaID" label="ID number" placeholder="Enter your ID number"
                                        />
                                </div>
                            </>
                        )}
